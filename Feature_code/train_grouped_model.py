...
def train(opt, run_name):
    ...
    # Environment
    base_env = gym.make("RL-Tetris-v0", render_mode=None)
    grouped_env = GroupedWrapper(base_env)
    features_obs = GroupedFeaturesObservation(grouped_env)
    grouped_env.observation_wrapper = features_obs
    env = grouped_env
